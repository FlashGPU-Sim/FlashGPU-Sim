...
BINARY_GROUP_BINARIES_test-sm100-unit = $(SM100_UNIT_TARGET)
...
SUITE_TARGETS_test = sm100 sm120 sm90
...
$(eval $(call REGISTER_SUITE_TARGET,test,sm100,SM100_B200,10.0,sm_100a))
...
# SM100/B200 FA4 and TCGen05 correctness tests.
TARGET_GROUP_BUILD_GROUP_test_sm100_unit = test-sm100-unit
TARGET_GROUP_BINARY_GROUP_test_sm100_unit = test-sm100-unit
TARGET_GROUP_EXECUTOR_test_sm100_unit = gtest-single
TARGET_GROUP_FILTER_test_sm100_unit = *
...
help:
	...
	@echo "=========================="
	@echo "  test:      sm100/unit; sm120/{unit,integration}; sm90/{instructions,fa2-smoke,fa3-smoke,fa3-packgqa}"
