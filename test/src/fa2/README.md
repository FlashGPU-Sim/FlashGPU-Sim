...
`test/src/fa3/flash-attention/csrc/flash_attn/src` checkout prepared by
`test/src/fa3/prepare_flash_attention.sh`.
...
all manifest-owned FA2 profiles. See `test/scripts/README.md` for the complete
