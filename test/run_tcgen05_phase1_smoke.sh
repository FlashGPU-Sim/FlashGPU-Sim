...
--check-inline, also compiles test/src/trace/tcgen05_instruction_surface_inline.cu
...
PTX_FILE="${PTX_FILE:-${ROOT_DIR}/test/src/trace/ptx/tcgen05_phase1_smoke.ptx}"
...
if [[ "${CHECK_INLINE}" -eq 1 ]]; then
  ...
  INLINE_SRC="${ROOT_DIR}/test/src/trace/tcgen05_instruction_surface_inline.cu"
