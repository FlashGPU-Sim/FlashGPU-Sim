...
5. Prefer `SM120_*_REDUCED_CLUSTER*` for functional tests; H200 reduced (`SM90_H200_REDUCED_CLUSTER16x2`) for functional NoC-on. Published cycle calibration uses full-chip GPC packing (`SM90_H200_CLUSTER16x8`, `docs/cluster_noc/calibration.md`).
