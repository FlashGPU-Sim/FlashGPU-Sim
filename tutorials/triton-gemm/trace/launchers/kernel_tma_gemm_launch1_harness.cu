...
// Kernel hash: a0461579b4ba84cf608dae723ac5333b63d754b26f7dafb0c29e872b1b95db92
...
int main(int argc, char** argv) {{
    ...
    void* d_arg0;
    size_t arg0_size = 13107200;
    void* d_arg1;
    size_t arg1_size = 327680;
    void* d_arg2;
    size_t arg2_size = 327680;
    int32_t arg3 = 2560;
    int32_t arg4 = 64;
    int32_t arg5 = 2560;

    d_arg0 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg0.bin", arg0_size, 0, "float16", "[2560, 2560]");
    if (!d_arg0) return 1;
    d_arg1 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg1.bin", arg1_size, 1, "float16", "[64, 2560]");
    if (!d_arg1) return 1;
    d_arg2 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg2.bin", arg2_size, 2, "float16", "[2560, 64]");
    if (!d_arg2) return 1;
    printf("  Set arg[3]: int = 2560\n");
    printf("  Set arg[4]: int = 64\n");
    printf("  Set arg[5]: int = 2560\n");
    ...
    // Total size = per_cta_size * grid_size * num_ctas = per_cta * 40
    cudaMalloc(&global_scratch, 15360);
    printf("  Allocated global_scratch: %zu bytes (alignment: %zu)\n",
           (size_t)15360, (size_t)128);
    ...
    // Validate outputs
    printf("\nValidating outputs...\n");
    validate_tensor_output(d_arg2, exe_path, "../data/kernel_tma_gemm_launch1_arg2_output.bin", arg2_size, 2, "float16");
