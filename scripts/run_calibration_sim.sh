#!/usr/bin/env bash
# Run a B6 calibration binary under FlashGPU-Sim.
# No H200 job. Default config is SM90_H200_CLUSTER132, 4 OpenMP threads.
#
# Usage:
...
setup_run_dir() {
  ...
  # GPGPU-Sim resolves -gpgpu_dsm_latency_matrix_file from the process cwd.
}
