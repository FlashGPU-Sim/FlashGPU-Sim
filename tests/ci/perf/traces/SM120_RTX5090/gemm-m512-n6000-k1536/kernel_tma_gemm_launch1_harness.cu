...
// Standalone harness for Triton kernel: kernel_tma_gemm
// Launch ID: 1
// Generated by TritonKernelTracker with captured arguments
// Kernel hash: 401762b2cc606d84a5a2ebf7d9744bd6419440ea6002d429a1588373cc75ea46
...
int main(int argc, char** argv) {{
    ...
    printf("Kernel: kernel_tma_gemm\n");
    printf("Launch ID: 1\n");
    printf("Grid: (752, 1, 1)\n");
    printf("Block: (128, 1, 1)\n");
    printf("Shared memory: 49176 bytes\n");
    printf("\n");
    ...
    snprintf(fatbin_path, sizeof(fatbin_path), "%s/kernel_tma_gemm_launch1_kernel.fatbin", exe_path);
    CUmodule module;
    ...
    CUresult func_result = cuModuleGetFunction(&kernel_func, module, "kernel_tma_gemm");
    ...
    printf("Got kernel function: kernel_tma_gemm\n");

    // Configure shared memory if needed (49176 bytes requires opt-in on some GPUs)
    int shared_mem_bytes = 49176;
    ...
    void* d_arg0;
    size_t arg0_size = 1572864;
    void* d_arg1;
    size_t arg1_size = 18432000;
    void* d_arg2;
    size_t arg2_size = 6144000;
    int32_t arg3 = 512;
    int32_t arg4 = 6000;
    int32_t arg5 = 1536;

    d_arg0 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg0.bin", arg0_size, 0, "float16", "[512, 1536]");
    if (!d_arg0) return 1;
    d_arg1 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg1.bin", arg1_size, 1, "float16", "[6000, 1536]");
    if (!d_arg1) return 1;
    d_arg2 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg2.bin", arg2_size, 2, "float16", "[512, 6000]");
    if (!d_arg2) return 1;
    printf("  Set arg[3]: int = 512\n");
    printf("  Set arg[4]: int = 6000\n");
    printf("  Set arg[5]: int = 1536\n");
    ...
    // Total size = per_cta_size * grid_size * num_ctas = per_cta * 752
    cudaMalloc(&global_scratch, 288768);
    printf("  Allocated global_scratch: %zu bytes (alignment: %zu)\n",
           (size_t)288768, (size_t)128);
    // Setup kernel arguments (user args + triton runtime args)
    void* args[] = { &d_arg0, &d_arg1, &d_arg2, &arg3, &arg4, &arg5, &global_scratch, &profile_scratch };
