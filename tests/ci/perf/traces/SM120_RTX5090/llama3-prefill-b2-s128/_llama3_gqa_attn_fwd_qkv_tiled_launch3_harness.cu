...
// Standalone harness for Triton kernel: _llama3_gqa_attn_fwd_qkv_tiled
// Launch ID: 3
// Generated by TritonKernelTracker with captured arguments
// Kernel hash: b41b0e0721d062f18d6e2d04174fb5862f0b20b2a0b8587ca901399186cb7a52
...
int main(int argc, char** argv) {{
    ...
    printf("Kernel: _llama3_gqa_attn_fwd_qkv_tiled\n");
    printf("Launch ID: 3\n");
    printf("Grid: (2, 64, 1)\n");
    printf("Block: (128, 1, 1)\n");
    printf("Shared memory: 24576 bytes\n");
    printf("\n");
    ...
    snprintf(fatbin_path, sizeof(fatbin_path), "%s/_llama3_gqa_attn_fwd_qkv_tiled_launch3_kernel.fatbin", exe_path);
    CUmodule module;
    ...
    CUresult func_result = cuModuleGetFunction(&kernel_func, module, "_llama3_gqa_attn_fwd_qkv_tiled");
    ...
    printf("Got kernel function: _llama3_gqa_attn_fwd_qkv_tiled\n");

    // Configure shared memory if needed (24576 bytes requires opt-in on some GPUs)
    int shared_mem_bytes = 24576;
    ...
    void* d_arg0;
    size_t arg0_size = 3145728;
    void* d_arg1;
    size_t arg1_size = 2097152;
    float arg2 = 0.08838834764831843;

    d_arg0 = load_tensor_arg(exe_path, "../data/_llama3_gqa_attn_fwd_qkv_tiled_launch3_arg0.bin", arg0_size, 0, "float16", "[4, 48, 64, 128]");
    if (!d_arg0) return 1;
    d_arg1 = load_tensor_arg(exe_path, "../data/_llama3_gqa_attn_fwd_qkv_tiled_launch3_arg1.bin", arg1_size, 1, "float16", "[4, 32, 64, 128]");
    if (!d_arg1) return 1;
    printf("  Set arg[2]: float = 0.08838834764831843\n");
    ...
    cudaMalloc(&global_scratch, 98304);
    printf("  Allocated global_scratch: %zu bytes (alignment: %zu)\n",
           (size_t)98304, (size_t)128);
