...
// Standalone harness for Triton kernel: _llama3_layer_matmul_tile
// Launch ID: 2
// Generated by TritonKernelTracker with captured arguments
// Kernel hash: 2bba546564bdf4d6dee34e093092d7282e53fa1377f0ceb04edb2c7c6d413d7b
...
int main(int argc, char** argv) {{
    ...
    printf("Kernel: _llama3_layer_matmul_tile\n");
    printf("Launch ID: 2\n");
    printf("Grid: (192, 1, 1)\n");
    ...
    snprintf(fatbin_path, sizeof(fatbin_path), "%s/_llama3_layer_matmul_tile_launch2_kernel.fatbin", exe_path);
    CUmodule module;
    ...
    CUresult func_result = cuModuleGetFunction(&kernel_func, module, "_llama3_layer_matmul_tile");
    ...
    printf("Got kernel function: _llama3_layer_matmul_tile\n");
    ...
    void* d_arg1;
    size_t arg1_size = 50331648;
    void* d_arg2;
    size_t arg2_size = 3145728;

    d_arg0 = load_tensor_arg(exe_path, "../data/_llama3_layer_matmul_tile_launch2_arg0.bin", arg0_size, 0, "float16", "[4, 32, 64, 128]");
    if (!d_arg0) return 1;
    d_arg1 = load_tensor_arg(exe_path, "../data/_llama3_layer_matmul_tile_launch2_arg1.bin", arg1_size, 1, "float16", "[48, 32, 128, 128]");
    if (!d_arg1) return 1;
    d_arg2 = load_tensor_arg(exe_path, "../data/_llama3_layer_matmul_tile_launch2_arg2.bin", arg2_size, 2, "float16", "[4, 48, 64, 128]");
    if (!d_arg2) return 1;
    ...
    // Total size = per_cta_size * grid_size * num_ctas = per_cta * 192
    cudaMalloc(&global_scratch, 73728);
    printf("  Allocated global_scratch: %zu bytes (alignment: %zu)\n",
           (size_t)73728, (size_t)128);
    // Setup kernel arguments (user args + triton runtime args)
    void* args[] = { &d_arg0, &d_arg1, &d_arg2, &global_scratch, &profile_scratch };
