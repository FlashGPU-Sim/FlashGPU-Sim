...
// Standalone harness for Triton kernel: flash_attn_kernel
// Launch ID: 5
// Generated by TritonKernelTracker with captured arguments
// Kernel hash: c781196d20a3607e239c34a41dc22a793394a19225f731565d89e08f30d70d75
...
int validate_tensor_output(void* d_actual, const char* exe_path, const char* rel_expected_path,
    ...
    int max_show = 300;  // max number of mismatches to print
    ...
    if (mismatches == 0) {
        ...
        printf("  Total mismatches for arg[%d]: %d / %zu (showing first %d)\n", arg_idx, mismatches, num_elements, max_show);
    }
...
int main(int argc, char** argv) {{
    ...
    printf("Kernel: flash_attn_kernel\n");
    printf("Launch ID: 5\n");
    printf("Grid: (4, 12, 1)\n");
    printf("Block: (128, 1, 1)\n");
    printf("Shared memory: 18464 bytes\n");
    printf("\n");
    ...
    snprintf(fatbin_path, sizeof(fatbin_path), "%s/flash_attn_kernel_launch5_kernel.fatbin", exe_path);
    CUmodule module;
    ...
    CUresult func_result = cuModuleGetFunction(&kernel_func, module, "flash_attn_kernel");
    ...
    printf("Got kernel function: flash_attn_kernel\n");

    // Configure shared memory if needed (18464 bytes requires opt-in on some GPUs)
    int shared_mem_bytes = 18464;
    ...
    void* d_arg0;
    size_t arg0_size = 196608;
    void* d_arg1;
    size_t arg1_size = 196608;
    void* d_arg2;
    size_t arg2_size = 196608;
    void* d_arg3;
    size_t arg3_size = 196608;
    int32_t arg4 = 12;
    int32_t arg5 = 128;
    int32_t arg6 = 64;
    int32_t arg7 = 128;
    ...
    d_arg0 = load_tensor_arg(exe_path, "../data/flash_attn_kernel_launch5_arg0.bin", arg0_size, 0, "float16", "[12, 128, 64]");
    if (!d_arg0) return 1;
    d_arg1 = load_tensor_arg(exe_path, "../data/flash_attn_kernel_launch5_arg1.bin", arg1_size, 1, "float16", "[12, 128, 64]");
    if (!d_arg1) return 1;
    d_arg2 = load_tensor_arg(exe_path, "../data/flash_attn_kernel_launch5_arg2.bin", arg2_size, 2, "float16", "[12, 128, 64]");
    if (!d_arg2) return 1;
    d_arg3 = load_tensor_arg(exe_path, "../data/flash_attn_kernel_launch5_arg3.bin", arg3_size, 3, "float16", "[12, 128, 64]");
    if (!d_arg3) return 1;
    printf("  Set arg[4]: int = 12\n");
    printf("  Set arg[5]: int = 128\n");
    printf("  Set arg[6]: int = 64\n");
    printf("  Set arg[7]: int = 128\n");
    printf("  Set arg[8]: float = 0.125\n");
    ...
    // Total size = per_cta_size * grid_size * num_ctas = per_cta * 48
    cudaMalloc(&global_scratch, 24576);
    printf("  Allocated global_scratch: %zu bytes (alignment: %zu)\n",
           (size_t)24576, (size_t)128);
    // Setup kernel arguments (user args + triton runtime args)
    void* args[] = { &d_arg0, &d_arg1, &d_arg2, &d_arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &global_scratch, &profile_scratch };
    ...
    // Validate outputs
    printf("\nValidating outputs...\n");
    validate_tensor_output(d_arg3, exe_path, "../data/flash_attn_kernel_launch5_arg3_output.bin", arg3_size, 3, "float16");
