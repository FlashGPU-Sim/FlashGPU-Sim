...
int main(int argc, char** argv) {{
    ...
    void* d_arg0;
    size_t arg0_size = 524288;
    void* d_arg1;
    size_t arg1_size = 16384;
    void* d_arg2;
    size_t arg2_size = 16384;
    int32_t arg3 = 512;
    int32_t arg4 = 16;
    int32_t arg5 = 512;

    d_arg0 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg0.bin", arg0_size, 0, "float16", "[512, 512]");
    if (!d_arg0) return 1;
    d_arg1 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg1.bin", arg1_size, 1, "float16", "[16, 512]");
    if (!d_arg1) return 1;
    d_arg2 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg2.bin", arg2_size, 2, "float16", "[512, 16]");
    if (!d_arg2) return 1;
    printf("  Set arg[3]: int = 512\n");
    printf("  Set arg[4]: int = 16\n");
    printf("  Set arg[5]: int = 512\n");
    ...
    // Total size = per_cta_size * grid_size * num_ctas = per_cta * 8
    cudaMalloc(&global_scratch, 3072);
    printf("  Allocated global_scratch: %zu bytes (alignment: %zu)\n",
           (size_t)3072, (size_t)128);
