...
int main(int argc, char** argv) {{
    ...
    void* d_arg0;
    size_t arg0_size = 33554432;
    void* d_arg1;
    size_t arg1_size = 1048576;
    void* d_arg2;
    size_t arg2_size = 1048576;
    int32_t arg3 = 4096;
    int32_t arg4 = 128;
    int32_t arg5 = 4096;

    d_arg0 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg0.bin", arg0_size, 0, "float16", "[4096, 4096]");
    if (!d_arg0) return 1;
    d_arg1 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg1.bin", arg1_size, 1, "float16", "[128, 4096]");
    if (!d_arg1) return 1;
    d_arg2 = load_tensor_arg(exe_path, "../data/kernel_tma_gemm_launch1_arg2.bin", arg2_size, 2, "float16", "[4096, 128]");
    if (!d_arg2) return 1;
    printf("  Set arg[3]: int = 4096\n");
    printf("  Set arg[4]: int = 128\n");
    printf("  Set arg[5]: int = 4096\n");
    ...
    cudaMalloc(&global_scratch, 49152);
    printf("  Allocated global_scratch: %zu bytes (alignment: %zu)\n",
           (size_t)49152, (size_t)128);
