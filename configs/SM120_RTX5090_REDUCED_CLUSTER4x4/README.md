...
Cluster / DSM design: `docs/cluster_noc/README.md`.

Reduced multi-cluster config with **m>2** physical packing for functional
validation of Thread Block Clusters larger than 2. DSM fabric is on.
...
- Primary **functional** regression target for m>2
...
- DSM fabric and remote mbarrier are on (`-gpgpu_dsm_enable 1`).
