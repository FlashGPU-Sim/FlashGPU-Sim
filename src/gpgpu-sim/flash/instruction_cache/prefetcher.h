...
public:
  instruction_prefetcher(bool enabled, unsigned streams, unsigned depth,
                         unsigned issue_width, unsigned gcc_preload_lines,
                         unsigned gcc_hit_latency, unsigned line_size,
...
private:
  ...
  unsigned m_gcc_preload_lines;
  unsigned m_gcc_hit_latency;
  unsigned m_sid;
  unsigned m_tpc;
  const memory_config *m_memory_config;
  gpgpu_sim *m_gpu;
  instruction_cache *m_cache;
